...
import {detalleCliente, listarClientes, registrarCliente} from "../controller/cliente_controller.js";
...
// router.put("/clientes/actualizar/:id", verificarAutenticacion,actualizarPaciente);
